      ...
      <div class="container border col-sm  rounded bg-white col-sm-6 p-5">
        <form>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="password" class="form-control border border-dark shadow-sm" id="campo_email" placeholder="Insira seu e-mail">
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="password" class="form-control border border-dark shadow-sm" id="campo_senha" placeholder="Insira sua senha">
            </div>
          </div>
